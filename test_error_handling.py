#!/usr/bin/env python3
"""Test the complete Cipercare API flow with improved error handling"""
...
print("\n" + "="*60)
print("CIPERCARE API TEST WITH IMPROVED ERROR HANDLING")
print("="*60 + "\n")
...
# Test 5: Error handling test - missing patient ID
print("[5] Testing error handling - missing patient ID...")
try:
    query_data = {
        "patient_id": "",
    ...
    if response.status_code == 400:
        print(f"[+] Error correctly handled (400 Bad Request)")
...
print("[+] Authentication working with improved error handling")
...
print("\nEND-TO-END INTEGRATION WITH IMPROVED ERROR HANDLING VERIFIED!")
