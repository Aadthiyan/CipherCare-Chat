...
def main():
    """Main upload process"""
    print("=" * 70)
    print("🚀 CipherCare Data Upload to Render")
    print("=" * 70)
    ...
    print(f"Estimated time: {len(records) * 0.015 / 60:.1f} minutes (optimized for speed)")
    print("\nProceed? [y/n]")
    ...
    #Upload
    print("\n" + "=" * 70)
    print("STEP 2: UPLOADING TO CYBORGDB ON RENDER")
    print("=" * 70)
